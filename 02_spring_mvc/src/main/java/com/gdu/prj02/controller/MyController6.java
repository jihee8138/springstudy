...
public class MyController6 {
  ...
  public String login1(HttpServletRequest request) {
    ...
    // 메인 페이지로 이동
    // return "index"; -> forward 방식  /  return "redirect:/main.do"; -> redirect 방식
  ...
  public String login2(Model model) {
    ...
    // model 에 객체 저장하기 (@SessionAttribute 에 의해서 session 에도 저장된다.) 
  ...
  public String logout2(SessionStatus sessionStatus) {
    ...
    // session attribute 삭제를 위한 세션 완료 처리
...
//  @GetMapping("/user/mypage.do")
  public String mypage1(HttpSession session, Model model) {
    ...
    // 모든 attribute 타입은 object이기때문에 타입이 안 맞으므로 캐스팅
